...
filebot -script fn:amc -no-xattr --output /data/Media --log-file /files/amc.log --action symlink --conflict auto \
  -non-strict --def ut_dir=/data/Media/Downloads/complete ut_kind=multi music=y deleteAfterExtract=y clean=y \
